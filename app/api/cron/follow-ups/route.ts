...
export async function GET(request: Request) {
  ...
  // When CRON_SECRET is configured, require it. Only fall back to Vercel's cron
  // user-agent on legacy deployments that do not yet have a secret configured.
  ...
  try {
    ...
    return NextResponse.json(
      { ok: true, followUps, managementBrief },
