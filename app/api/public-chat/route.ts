...
export async function POST(request: Request) {
  ...
  try {
    ...
    try {
      ...
      const reply = fallback || "I had a brief connection problem, but your contact details are saved. Please send that message once more and I’ll continue from here.";
